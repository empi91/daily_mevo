...
- [ ] 4.1 test-plan.md §6.2 and §6.5 no longer contain "TBD"
- [ ] 4.2 test-plan.md §3 Phase 2 status is `complete`
- [ ] 4.3 RUNNING_TESTS.md includes all new test commands

#### Manual

- [ ] 4.4 Cookbook patterns match actual implementation
- [ ] 4.5 A developer could add an endpoint test by following §6.5
